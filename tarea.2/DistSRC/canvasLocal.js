...
CanvasLocal.prototype.color='#0d6efd';
CanvasLocal.prototype.resetZoom=function(){
 this.rWidth=8; this.rHeight=6; this.recalcularEscala(); this.paint();
};
const oldPaint=CanvasLocal.prototype.paint;
CanvasLocal.prototype.paint=function(){
 oldPaint.call(this);
 this.graphics.strokeStyle=this.color||'#0d6efd';
};
